...
Integration.create(change_list: 432463, owner: 'Dora', time_started: '2014-4-17 7:40', build: 1, unit_test: 0.8, functional_test: 0, status: 'Running')
Integration.create(change_list: 432462, owner: 'Samy', time_started: '2014-4-17 6:42', build: 0, unit_test: 1, functional_test: 1, status: 'Passed')
...
Integration.create(change_list: 432458, owner: 'Dora', time_started: '2014-4-17 1:14', build: 1, unit_test: 1, functional_test: 0, status: 'Failed')